...
useEffect(() => { 
  // if (isLoaded === false) {
    axios.get(`http://172.16.1.240:32454/api/v1/encs-app-env-master`,
    {
      headers: {               
...
//-----------------------------------------Delete method----------------------------------------------------------------------
 const removeData = (appEnvName, applicationId) => {
   const appid_delete = applicationId
   const appname_delete = appEnvName
   console.log(appid_delete)
   console.log(appname_delete)
   if (confirm("Are you sure you want to delete this?")) {
  axios.delete(`http://172.16.1.240:32454/api/v1/encs-app-env-master`,
  {
    headers: {               
      "Content-Type": "application/json",
      "access-token": `${token}`

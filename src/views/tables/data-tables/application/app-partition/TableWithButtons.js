...
useEffect(() => { 
  // if (isLoaded === false) {
    axios.get(`http://172.16.1.240:32454/api/v1/encs-app-partition-details`,
    {
      headers: {               
...
//-----------------------------------------Delete method----------------------------------------------------------------------
 const removeData = (appPartitionId, applicationId) => {
  const apppartitionid_delete = appPartitionId
  const applicationid_delete = applicationId
  console.log(apppartitionid_delete)
  console.log(applicationid_delete)
  if (confirm("Are you sure you want to delete this?")) {
  axios.delete(`http://172.16.1.240:32454/api/v1/encs-app-partition-details`,
  {
    headers: {               
      "Content-Type": "application/json",
      "access-token": `${token}`
    ...
    cell: row => (
      <div className='d-flex align-items-center'>
        <div className='user-info text-truncate '>
          <span className='d-block font-weight-bold text-truncate' style={{width:'150px'}}>{row.applicationId}</span>

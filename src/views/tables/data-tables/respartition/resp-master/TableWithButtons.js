...
useEffect(() => { 
  // if (isLoaded === false) {
    axios.get(`http://172.16.1.240:32454/api/v1/encs-res-partition-master`,
    {
      headers: {               
...
//-----------------------------------------Delete method----------------------------------------------------------------------
 const removeData = (iscTechCategoryName) => {
  ...
  axios.delete(`http://172.16.1.240:32454/api/v1/encs-res-partition-master`,
  {
    headers: {               
      "Content-Type": "application/json",
      "access-token": `${token}`
    ...
    <Fragment>
      <Card>
        <CardHeader className="flex-md-row flex-column align-md-items-center align-items-start border-bottom">
          <CardTitle tag="h4" style={{ color: 'white'}}>Respartition Master</CardTitle>

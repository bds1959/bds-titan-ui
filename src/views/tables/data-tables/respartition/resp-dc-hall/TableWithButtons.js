...
useEffect(() => { 
  // if (isLoaded === false) {
    axios.get(`http://172.16.1.240:32454/api/v1/encs-res-partition-dc-hall`,
    {
      headers: {               
...
//-----------------------------------------Delete method----------------------------------------------------------------------
 const removeData = (iscTechCategoryName) => {
  ...
  axios.delete(`http://172.16.1.240:32454/api/v1/encs-res-partition-dc-hall/${iscTechCategoryName}`,
  {
    headers: {               
      "Content-Type": "application/json",
      "access-token": `${token}`
 ...
 const columns = [
    ...
    cell: row => (
      <div className='d-flex align-items-center'>
        <div className='user-info text-truncate '>
          <span className='d-block font-weight-bold text-truncate'style={{width:'150px'}}>{row.customerId}</span>
  ...
  },
  {
    ...
    cell: row => (
      <div className='d-flex align-items-center'>
        <div className='user-info text-truncate '>
          <span className='d-block font-weight-bold text-truncate'style={{width:'150px'}}>{row.dcHallId}</span>
          {/* <small>{row.post}</small> */}
        </div>
      </div>
    )
  ...
  },
  {
    ...
    cell: row => (
      <div className='d-flex align-items-center'>
        <div className='user-info text-truncate '>
          <span className='d-block font-weight-bold text-truncate'style={{width:'150px'}}>{row.resPartitionDcHallId}</span>
          {/* <small>{row.post}</small> */}
        </div>
      </div>
    )
    ...
    <Fragment>
      <Card>
        <CardHeader className="flex-md-row flex-column align-md-items-center align-items-start border-bottom">
          <CardTitle tag="h4" style={{ color: 'white'}}>RESPARTITION DC HALL</CardTitle>

...
const removeData = (iscTechCategoryName) => {
  const deletevar = iscTechCategoryName
  if (confirm("Are you sure you want to delete this?")) {
    axios.delete(`http://172.16.1.240:32454/api/v1/encs-tech-category-master`,
  {
    headers: {               
      "Content-Type": "application/json",
      "access-token": `${token}`
    },
    data : {iscTechCategoryName : deletevar}
  }
  ).then((response) => {
 ...
 const columns = [
    ...
    cell: row => {
      return (
        <div className='d-flex'>
              ...
              <div tag='a'  className='w-100'  onClick={() => removeData(row.iscTechCategoryName)}>
                <Trash size={15} />
              </div>
  ...
  return (
    <Fragment>
      <Card>
        <CardHeader className="flex-md-row flex-column align-md-items-center align-items-start border-bottom">
          <CardTitle tag="h4" style={{color:'white'}}>Encs Tech Category Master</CardTitle>
    ...
    borderBottomRightRadius: '5px'}}>
              ...
              {/* <DownloadCloud size={15} style={{ width: '13px'}}/> */}
                {/* <Share size={15} style={{ width: '11px'}}/> */}

...
useEffect(() => { 
  // if (isLoaded === false) {
    axios.get(`http://172.16.1.240:32454/api/v1/encs-os-tech-master`,
    {
      headers: {               
...
//-----------------------------------------Delete method----------------------------------------------------------------------
 const removeData = (iscOsTechName) => {
  const deletevar = iscOsTechName
  if (confirm("Are you sure you want to delete this?")) {
    axios.delete(`http://172.16.1.240:32454/api/v1/encs-os-tech-master`,
  {
    headers: {               
      "Content-Type": "application/json",
      "access-token": `${token}`
 ...
 const columns = [
  ...
  },
  {
    ...
    cell: row => (
      <div className='d-flex align-items-center'>
        <div className='user-info text-truncate '>
          <span className='d-block font-weight-bold text-truncate'>{row.iscOsTechTags}</span>
          {/* <small>{row.post}</small> */}
        </div>
      </div>
    )
    ...
    cell: row => (
      <div className='d-flex align-items-center'>
        <div className='user-info text-truncate ml-1'>
          <span className='d-block font-weight-bold text-truncate'  style={{width:'250px'}}>{row.iscOsTechDescription}</span>
        </div>
      </div>
    )
  },
    ...
    <Fragment>
      <Card>
        <CardHeader className="flex-md-row flex-column align-md-items-center align-items-start border-bottom">
          <CardTitle tag="h4" style={{ color: 'white'}}>Os Tech Category Master</CardTitle>

...
useEffect(() => { 
  // if (isLoaded === false) {
    axios.get(`http://172.16.1.240:32454/api/v1/encs-customer-contact`,
    {
      headers: {               
...
//-----------------------------------------Delete method----------------------------------------------------------------------
 const removeData = (customerContactId) => {
  ...
  const deletevar = customerContactId
  axios.delete(`http://172.16.1.240:32454/api/v1/encs-customer-contact`,
  {
    headers: {               
      "Content-Type": "application/json",
      "access-token": `${token}`
    ...
    <Fragment>
      <Card>
        <CardHeader className="flex-md-row flex-column align-md-items-center align-items-start border-bottom">
          <CardTitle tag="h4" style={{ color: 'white'}}>Customer Contact Details</CardTitle>

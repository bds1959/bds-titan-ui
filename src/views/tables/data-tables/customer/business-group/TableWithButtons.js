...
useEffect(() => { 
  // if (isLoaded === false) {
    axios.get(`http://172.16.1.240:32454/api/v1/encs-business-group-details`,
    {
      headers: {               
...
//-----------------------------------------Delete method----------------------------------------------------------------------
 const removeData = (businessGroupId) => {
  ...
  const deletevar = businessGroupId
  console.log("Test print pk", deletevar)
  if (confirm("Are you sure you want to delete this?")) {
  axios.delete(`http://172.16.1.240:32454/api/v1/encs-business-group-details`,
   {   
    headers: {               
      "Content-Type": "application/json",
      "access-token": `${token}`
    ...
    <Fragment>
      <Card>
        <CardHeader className="flex-md-row flex-column align-md-items-center align-items-start border-bottom">
          <CardTitle tag="h4" style={{ color: 'white'}}>Customer Business Details</CardTitle>
